...
#define X_FOOTER_COL_2 50
#define X_FOOTER_COL_3 120
#define X_FOOTER_COL_4 180
#define X_FOOTER_COL_5 210
...
void print_page_footer2( int percent )
{ 
    char bafr[50];
    sprintf( bafr, "%d%%", percent );
    int color =  TFT_GREEN;
    if( percent>50 ) {
            color = TFT_YELLOW;
    }
